<script lang="ts">
	...
	async function performReorder() {
		const newOrder = gameContext.gameManager.getUserCardsIdsOrderdByValueAndSequentialOfSameColor();
...
<Button onclick={performReorder}>
	<span class="black-cards">12</span>
	<span class="yellow-cards">23</span>
</Button>
